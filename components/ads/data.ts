...
export const MOCK_CAMPAIGNS = [
  {
    id: "1",
    name: "Ramadan акция — салфетки оптом",
...
export const MOCK_AI_RECS = [
  {
    ...
    description:
      "CTR 1.2% за 48 часов. AI зафиксировал 92% статистическую значимость — креатив проиграл.",
    action: "Остановить",
  },
  {
    id: "2",
    ...
    description:
      "ROAS 380% и растёт. При ₽130k/мес AI прогнозирует ROAS 350% и +35 заявок.",
    action: "Применить",
  },
  {
    id: "3",
...
export const MOCK_REPORTS = [
  {
    id: "1",
    title: "Еженедельный отчёт · 19-26 мая",
    subtitle: "Пятый элемент · все платформы · PDF",
    status: "sent" as const,
    icon: "📄",
  },
  {
    id: "2",
    title: "Месячный отчёт · апрель 2026",
    subtitle: "Все проекты · ROI 340% · AI комментарий",
    status: "live" as const,
    icon: "📊",
  },
  {
    id: "3",
    title: "Авто-отправка каждый пн 09:00",
    subtitle: "Email + Telegram · 3 клиента",
