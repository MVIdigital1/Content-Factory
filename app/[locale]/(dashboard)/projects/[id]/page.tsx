...
export default function ProjectDetailPage() {
  ...
  const [settingsStopWords, setSettingsStopWords] = useState("");
  ...
  useEffect(() => {
    if (project !== undefined && guidelinesText === null) {
      setGuidelinesText((project?.brand_guidelines as string) ?? "");
    }
  }, [project]);
  ...
  useEffect(() => {
    if (project && !settingsInitialized) {
      ...
      setSettingsStopWords((project as any).stop_words || "");
      setSettingsLogoUrl(project.logo_url || "");
      setSettingsInitialized(true);
    }
  }, [project, settingsInitialized]);
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mt-1">
                      ...
                      <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button
                          onClick={() => deleteFileMutation.mutate({ id: f.id, file_url: f.file_url })}
          ...
          <div className="max-w-2xl space-y-5">
            ...
            <div className="bg-panel border border-line rounded-xl p-4">
              ...
              <button
                onClick={() =>
                  saveBrandbookMutation.mutate({
                    brand_guidelines: guidelinesText ?? "",
                  })
                }
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    onBlur={() =>
                      saveBrandbookMutation.mutate({ name: settingsName })
                    }
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    value={settingsStopWords}
                    onChange={(e) => setSettingsStopWords(e.target.value)}
                    placeholder="скидка, акция, дешево — через запятую"
                    className="w-full px-3 py-2.5 border border-line-strong rounded-lg text-sm outline-none focus:border-accent"
                    onBlur={() =>
                      saveBrandbookMutation.mutate({
                        stop_words: settingsStopWords,
                      })
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 border border-line-strong rounded-lg text-sm outline-none focus:border-accent"
                    onBlur={() =>
                      saveBrandbookMutation.mutate({ logo_url: settingsLogoUrl })
                    }
                  />
                </div>
              </div>
