...
const TEMPLATES = [
  {
    id: "classic",
    name: "Классический",
    desc: "Одноколоночный лаконичный дизайн",
    pro: false,
    preview: "🗂️",
  },
  {
  ...
  },
  {
    id: "big-photo",
    name: "Большое фото",
    desc: "Полноэкранное изображение фона",
    pro: false,
    preview: "🖼️",
  },
  {
      ...
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <div
                    style={{
                      ...
                      fontSize: 12,
                      fontWeight: 700,
                      background: done || active ? "var(--accent)" : "var(--chip)",
                      color: done || active ? "var(--on-accent)" : "var(--tx-3)",
                      flexShrink: 0,
                    }}
                  >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              <Field label="Название бизнеса *">
                <input
                  ...
                  onChange={set1("businessName")}
                  placeholder="напр. Клиника Здоровье"
                  style={inputStyle}
                />
              </Field>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              <Field label="Город и страна">
                <input
                  value={step1.city}
                  onChange={set1("city")}
                  placeholder="напр. Ташкент, Узбекистан"
                  style={inputStyle}
                />
              </Field>
              <Field label="Цвет бренда">
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <input
                    type="color"
                    value={step1.brandColor}
                    onChange={set1("brandColor")}
                    style={{
                      width: 40,
                      height: 36,
            ...
            <Field label="Главный оффер — что предлагаете *">
              <textarea
                value={step1.offer}
                onChange={set1("offer")}
                placeholder="напр. Лечение зубов без боли за 1 визит"
                rows={2}
            ...
            <Field label="Целевая аудитория *">
              <textarea
                ...
                onChange={set1("audience")}
                placeholder="напр. Взрослые 25–55 лет, боящиеся стоматологов"
                rows={2}
                style={{ ...inputStyle, resize: "vertical" }}
              />
            </Field>
            ...
            <Field label="Главная боль клиента">
              <textarea
                value={step1.pain}
                onChange={set1("pain")}
                placeholder="напр. Страх боли и дорогого лечения"
                rows={2}
                style={{ ...inputStyle, resize: "vertical" }}
              />
            </Field>
            ...
            <Field label="Три преимущества (через запятую)">
              <textarea
                value={step1.advantages}
                onChange={set1("advantages")}
                placeholder="напр. Современное оборудование, Без боли, Гарантия 2 года"
                rows={2}
                style={{ ...inputStyle, resize: "vertical" }}
              />
            </Field>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: 12,
                      overflow: "hidden",
                      cursor: tpl.pro ? "default" : "pointer",
                      opacity: tpl.pro ? 0.6 : 1,
                      background: "var(--panel)",
        ...
        {step === 3 && (
          <div>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: 10,
                      overflow: "hidden",
                      cursor: img.pro ? "default" : "pointer",
            ...
            >
              <p style={{ fontSize: 13, fontWeight: 600, color: "var(--tx-1)", marginBottom: 8 }}>
                ✦ Описать фон для AI
              </p>
              <textarea
                value={aiPrompt}
                onChange={(e) => setAiPrompt(e.target.value)}
                placeholder="напр. Современный офис с большими окнами, теплые тона"
                rows={2}
                style={{ ...inputStyle, resize: "vertical" }}
              />
              <p style={{ fontSize: 11, color: "var(--tx-3)", marginTop: 6 }}>
                Генерация фонов через AI будет доступна скоро
              </p>
            </div>
